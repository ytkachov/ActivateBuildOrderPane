//------------------------------------------------------------------------------
// <copyright file="ActivateBuildOrderPanePkg.cs" company="YuriTkachov">
...
namespace ActivateBuildOrderPane
{
  ...
  [Guid(ActivateBuildOrderPanePkg.PackageGuidString)]
  [SuppressMessage("StyleCop.CSharp.DocumentationRules", "SA1650:ElementDocumentationMustBeSpelledCorrectly", Justification = "pkgdef, VS and vsixmanifest are valid VS terms")]
  [ProvideMenuResource("Menus.ctmenu", 1)]
  public sealed class ActivateBuildOrderPanePkg : Package, IVsUpdateSolutionEvents
  {
    /// <summary>
    /// ActivateBuildOrderPane GUID string.
    /// </summary>
    public const string PackageGuidString = "95894204-7e71-4f90-a10b-03893a7a3256";

    private IVsOutputWindow _outputWindow = null;
    private IVsOutputWindowPane _buildOrderPane = null;
    private IVsSolutionBuildManager2 _solutionBuildManager = null;
    private uint _updateSolutionEventsCookie;

    /// <summary>
    /// Initializes a new instance of the <see cref="ActivateBuildOrderPanePkg"/> class.
    /// </summary>
    public ActivateBuildOrderPanePkg()
    {
...
#region Package Members
    ...
    {
      if (_buildOrderPane != null && ActivateBuildOrderPaneCmd.Pressed)
      {
        _buildOrderPane.Activate();
      }
